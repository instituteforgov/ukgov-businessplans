...
'''
#===============================================================================
# Objective: collect all data from No. 10 business plan API, build a database with this data, 
...
from unescape_html import unescape
...
writecsv = 1 # 0 to skip writing CSV; set to 0 for debugging download
analytics = 0 # 1 to run aggregate analytics; set to 0 for debugging download/raw data write
timeseriesanalytics = 0 # 1 to run time-series analytics.
...
if writecsv == 1:
    ...
    csvout_final = '../output/BusinessPlans_current'
    writer = csv.writer(open(csvout, 'wb'), csv.QUOTE_ALL)
            ...
            for subaction in action['sub_actions']:
                ...
                if ended == True:
                    ...
                    if ((sched_end_endmonth0.month > act_end0.month) & (sched_end_endmonth0 > act_end0)):
                        ...
                        endedlateby = 'NA'
                        endearlyby = 'NA'
                    elif sched_end_endmonth0 < act_end0:
                        end_status = 'Late'
                        endearlyby = 'NA'
                ...
                if ((sched_start_text != 1)):
                    ...
                    duetostartinlast30days = (sched_start_endmonth0 < today.replace(month=today.month - 1))
                else:
                ...
                if ((sched_end_text != 1)):
                    ...
                    duetoendinlast30days = (sched_end_endmonth0 < today.replace(month=today.month - 1))
                else:
                ...
                if ((started == True) & (sched_start_text == False)):
                    ...
                    startedinlast30days = (act_start0 < today.replace(month=today.month - 1))
                else:
                    startedthismonth = 'NA'
                ...
                if ((ended == True) & (sched_end_text == False)):
                    ...
                    endedinlast30days = (act_end0 < today.replace(month=today.month - 1))
                else:
                    endedthismonth = 'NA'
                ...
                row0 = [dept_abb, dept_name, dept_id, dept_url, priority_body, priority_id, priority_strapline, action_id, action_body, \
                       ...
                       duetostartlastmonth, duetoendinlast30days, duetoendlastmonth, duetoendinlast30days, \
                       startedthismonth, startedinlast30days, endedthismonth, endedinlast30days, \
                       carriedover, # add new stuff here - it's won't throw off the counting of items in the analytics\
                ...
                for cell in row0:
                    if isinstance(cell, basestring):
                        ...
                        t1 = unescape(textcell)
                        t0 = re.sub(t1, '\n', '')
                        t = t0.replace(' & #39;', '\'').replace('&amp;#39;', '\'').replace('&amp;#40;', '\'').replace('&amp;#41;', '\'')
                ...
                if writecsv == 1:
                    ...
                    print('NOTE: no CSV writing done - test run only. See switch at top of script')
...
if analytics == 1:
    ...
    import bp_analytics
    execfile(bp_analytics)

if timeseriesanalytics != 0:
    print 'Starting analytics'
    import bp_timeseries
    execfile(bp_timeseries)
